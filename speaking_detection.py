...
ap.add_argument("-fps", "--fps", type=int, default=5,
...
print("FPS: ",args["fps"], ", interval: ", interval)
...
while (vs.isOpened()):
    ...
    for rect in rects:
        ...
        cv2.putText(frame, state, (x, y), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 255), 1, cv2.LINE_AA)
        prev_mouth_img = mouth_img
        out.write(frame)
    # show the frame
